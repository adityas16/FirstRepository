...
read_competition <- function (){
  competitions = read.csv(paste(WELT_FOLDER,"extractedCSV/competitions.csv",sep="/"))
...
read_pso <- function (){
  ...
  pso = read.csv(paste(WELT_FOLDER,"processedCSV/pso_extended.csv",sep="/"))
  ...
  if(include_model_data ==1){
    model_output = read.csv(paste(WELT_FOLDER,"processedCSV/pso_model_output.csv",sep="/"))
...
read_in_play_penalties = function(){
  inplay_goals = read.csv(paste(WELT_FOLDER,"extractedCSV/goals.csv",sep="/"))
...
read_keepers <- function (){
  keepers = read.csv(paste(WELT_FOLDER,"joined/keeper_penalty_stats.csv",sep="/"))
  return (keepers);
}
...
read_shooters_with_cumulate_stats = function(){
  shooters = read.csv(paste(WELT_FOLDER,"joined/shooter_penalty_stats.csv",sep="/"))
...
read_manually_marked_competitions = function(){
  manually_marked_competitions = read.csv(paste(WELT_FOLDER,"extractedCSV/manually_marked_competitions.csv",sep="/"))
